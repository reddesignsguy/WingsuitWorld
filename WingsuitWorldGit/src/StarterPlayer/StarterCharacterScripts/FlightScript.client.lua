...
--print("reintiializing starter char script")
---- States
--local points = 0
...
--	_G.flightMode = true -- TODO: Remove in prod
--	enteredFlightModeEvent:FireServer(plr)
--	enteredFlightModeClientEvent:Fire()
...
----		-- TODO: Set up disconnection
----		data.Part.Touched:Connect(function(part)
...
--	print("stopped")
--	exitedFlightModeEvent:FireServer(crashed)
--	exitedFlightModeClientEvent:Fire()
--	-- 
--	resetState()
...
--	if numHits >= 8 then
--		print("Client close call! " .. tostring(time()))
